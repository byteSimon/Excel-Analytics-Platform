...
export const getEmailConfig = (): EmailConfig | null => {
  ...
  if (!service) {
    console.log(
      "Email service not configured. Set EMAIL_SERVICE in your environment variables."
    );
    return null;
  }
  ...
  switch (service) {
    case "gmail":
      ...
      console.log("  Gmail config:", {
        ...gmailConfig,
        pass: gmailConfig.pass ? "SET" : "NOT SET",
      });
      return gmailConfig;
    ...
    case "sendgrid":
      return {
        ...
        from: process.env.EMAIL_FROM || "noreply@exelanalyticsplatform.com",
      };
