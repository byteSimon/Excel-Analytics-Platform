    ...
    <AuthBackground>
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          >
            <div
              className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl mb-4 shadow-2xl transition-all duration-1000 delay-200 ${
            ...
            <h1
              className={`text-3xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 transition-all duration-1000 delay-400 ${
                animateElements
                  ? "opacity-100 translate-y-0"
            ...
            <p
              className={`text-gray-300 text-sm transition-all duration-1000 delay-600 ${
                animateElements
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-5"
              }`}
          ...
          <Card
            className={`backdrop-blur-xl bg-white/10 border-white/20 shadow-2xl transition-all duration-1000 delay-300 ${
              animateElements
          ...
          >
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div
                  className={`text-right transition-all duration-700 delay-700 ${
                    animateElements
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-5"
                  }`}
            ...
            <CardFooter className="flex flex-col space-y-4 pt-6">
              <div
                className={`text-sm text-center text-gray-300 transition-all duration-700 delay-1000 ${
                  animateElements
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-5"
                }`}
          ...
          <div
            className={`mt-8 grid grid-cols-3 gap-4 transition-all duration-1000 delay-500 ${
              animateElements
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            <div
              className={`text-center p-3 bg-white/5 rounded-lg backdrop-blur-sm border border-white/10 transition-all duration-500 delay-600 hover:scale-105 hover:bg-white/10 ${
                animateElements
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-5"
              }`}
            >
              ...
              <p className="text-xs text-gray-300">Data Analytics</p>
            </div>
            <div
              className={`text-center p-3 bg-white/5 rounded-lg backdrop-blur-sm border border-white/10 transition-all duration-500 delay-700 hover:scale-105 hover:bg-white/10 ${
                animateElements
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-5"
              }`}
            ...
            <div
              className={`text-center p-3 bg-white/5 rounded-lg backdrop-blur-sm border border-white/10 transition-all duration-500 delay-800 hover:scale-105 hover:bg-white/10 ${
                animateElements
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-5"
              }`}
          ...
          <div
            className={`mt-6 text-center transition-all duration-1000 delay-1200 ${
              animateElements
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-5"
            }`}
